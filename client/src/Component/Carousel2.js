...
function Carousel2() {
  return (
    <div class="w-full flex justify-between h-[58vw] ">
      <div class="left flex flex-col gap-3 relative">
        <div class="box"><div className=" flex-1 sm:flex-2 w-[110vw] sm:w-[60vw] md:w-[60vw] lg:w-[60vw] h-[60vw] lg:h-[60vw] md:-top-8 lg:-top-36 -left-16 lg:-left-20 bg-cyan-200 rounded-full grid place-content-center absolute "></div></div>
        <div class="box"><div className=" flex-1 sm:flex-2 w-[110vw] sm:w-[60vw] md:w-[60vw] lg:w-[60vw] h-[60vw] lg:h-[60vw] md:-top-8 lg:-top-36 -left-24 lg:-left-36 bg-cyan-400 rounded-full grid place-content-center absolute opacity-50 "></div></div>
      ...
      <div class="right flex align-middle ">
        <div class="box hidden sm:block md:block">
          <img src={img1} className="mt-20 w-56 object-cover lg:w-[500px] md:w-80" alt="" />
        </div>
      </div>
